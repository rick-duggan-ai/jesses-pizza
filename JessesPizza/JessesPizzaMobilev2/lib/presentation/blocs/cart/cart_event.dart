...
class RemoveItem extends CartEvent {
  final String menuItemId; final String sizeName; final int? index;
  const RemoveItem(this.menuItemId, this.sizeName, {this.index});
  @override List<Object?> get props => [menuItemId, sizeName, index];
}
class UpdateQuantity extends CartEvent {
  final String menuItemId; final String sizeName; final int quantity; final int? index;
  const UpdateQuantity(this.menuItemId, this.sizeName, this.quantity, {this.index});
  @override List<Object?> get props => [menuItemId, sizeName, quantity, index];
}
class SetDeliveryMode extends CartEvent {
  final bool isDelivery;
  const SetDeliveryMode(this.isDelivery);
  @override List<Object?> get props => [isDelivery];
}
