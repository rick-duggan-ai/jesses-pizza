...
{
    public class OrderFailedEmailModel : PageModel
    {
        ...
        public OrderFailedEmailModel(MongoTransaction transaction, List<Group> groups, List<MainMenuItem> mainMenuItems,bool isDelivery)
        {
