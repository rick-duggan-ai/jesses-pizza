...
{
    public class OrderCompleteEmailModel : PageModel
    {
        ...
        public OrderCompleteEmailModel(MongoTransaction transaction, List<Group> groups, List<MainMenuItem> mainMenuItems,bool isDelivery)
        {
        ...
        public OrderCompleteEmailModel(MongoTransactionV1_1 transaction, List<Group> groups, List<MainMenuItem> mainMenuItems, bool isDelivery)
        {
